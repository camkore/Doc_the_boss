...
$sqlQuery="SELECT * 
FROM  prescription
WHERE drug='$prescriptionStr_val'";                      
...
$drug_instructions=$row['instruction'];        
    ...
    ?>   
                ...
                <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="data[0][addOpd_quantity]" value="<?php echo $drug_quantity;?>">
                        </div>
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="data[0][addOpd_instructions]" value="<?php echo $drug_instructions;?>">
                        </div>
